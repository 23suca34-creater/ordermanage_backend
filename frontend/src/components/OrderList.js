        ...
        <div className="overflow-x-auto bg-white rounded-lg shadow">
          <table className="w-full">
            <thead className="bg-gray-200">
              <tr>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Order #</th>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Product</th>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Qty</th>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Total Price</th>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Status</th>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Customer</th>
