          ...
          <table className="w-full">
            <thead className="bg-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">SKU</th>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Price</th>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Quantity</th>
                <th className="px-6 py-3 text-left text-gray-800 font-semibold">Category</th>
